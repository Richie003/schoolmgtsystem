    ...
    <section id={feature.id} className="scroll-mt-24 border-b border-white/10 py-16 last:border-0">
      <Reveal>
        ...
        >
          ...
          {/* Visual: a small "spec sheet" panel */}
          <div className="relative">
            <div className="absolute inset-0 -z-10 translate-x-4 translate-y-4 rounded-2xl bg-brand-600/20 blur-xl" />
            <div className="rounded-2xl border border-white/10 bg-gray-900 p-6 shadow-xl shadow-black/40">
              <div className="flex items-center gap-3 border-b border-white/10 pb-4">
                <span className="flex h-12 w-12 items-center justify-center rounded-xl bg-brand-600 text-brand-contrast">
                ...
                <div>
                  ...
                  <p className="font-semibold text-white">{feature.eyebrow}</p>
                </div>
              </div>
              <dl className="mt-4 grid grid-cols-2 gap-3">
                {feature.facts.map((fact) => (
                  <div key={fact.label} className="rounded-xl bg-white/5 p-3">
