...
class School(TimeStampedModel):
    ...
    # Billing tier. Premium unlocks metered features (e.g. unlimited AI question
    # generation); free schools get a small trial allowance. Kept deliberately
    # simple — a single enum — until real billing exists.
