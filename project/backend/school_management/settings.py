...
# ---------------------------------------------------------------------------
# AI question generation (CBT)
# ---------------------------------------------------------------------------
# Anthropic Claude powers the auto question generator. Leave the key empty to
# disable generation (jobs fail with a clear "not configured" message).
ANTHROPIC_API_KEY = config('ANTHROPIC_API_KEY', default='')
AI_QUESTION_MODEL = config('AI_QUESTION_MODEL', default='claude-opus-5')
# Free successful generations a non-premium school gets before the feature is
# gated behind the premium plan.
AI_GENERATION_FREE_TRIALS = config('AI_GENERATION_FREE_TRIALS', default=3, cast=int)
